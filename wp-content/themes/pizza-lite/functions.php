...
define('PIZZA_LITE_SKTTHEMES_URL','https://www.sktthemes.org','pizza-lite');
define('PIZZA_LITE_SKTTHEMES_PRO_THEME_URL','https://www.sktthemes.org/shop/pizza-ordering-wordpress-theme/','pizza-lite');
define('PIZZA_LITE_SKTTHEMES_FREE_THEME_URL','https://www.sktthemes.org/shop/free-pizza-wordpress-theme/','pizza-lite');
define('PIZZA_LITE_SKTTHEMES_THEME_DOC','http://sktthemesdemo.net/documentation/pizza-documentation/','pizza-lite');
define('PIZZA_LITE_SKTTHEMES_LIVE_DEMO','https://www.sktperfectdemo.com/demos/pizzaordering/','pizza-lite');
define('PIZZA_LITE_SKTTHEMES_THEMES','https://www.sktthemes.org/themes/','pizza-lite');
